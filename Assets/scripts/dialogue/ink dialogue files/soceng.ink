...
=== soceng2 ===
Hey, look, this looks like a help stand! #speaker:Console  #portrait:console_evilexcited
...
#puzzle:phishingMinigame
Navigate through the rows and columns of the word grid with the arrow keys. #portrait:console_neutral
...
VAR employeeName = ""
=== email ====
I have generated a phishing email that will surely catch us that door code! #speaker:Console #portrait:console_evilexcited
...
#puzzle:closePuzzle
Dear {employeeName}, #speaker:Info Bot  
...
===reception===
It would be weird if I talk here since I'm just a games console, so you're on your own buddy. #speaker:Console  #portrait:console_neutral
...
Um, it's... {firstName} {lastName}. #speaker:You #portrait:you_neutral
...
===nitrozest===
(The fizzy green liquid smells citrusy)#speaker:You  #portrait:you_neutral
->DONE

===pool===
(There's something slimy and vaguely humanoid bubbling at the bottom of the pool.) #speaker:You  #portrait:you_neutral
->DONE

===painting===
(You're not sure if this is a window or a painting) #speaker:You  #portrait:you_confused
->DONE
...
There are no interns named {firstName} {lastName} working at this lab. #speaker:Guard Bot  #portrait:Default
